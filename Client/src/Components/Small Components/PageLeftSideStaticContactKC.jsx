...
//TODO FIGURE OUT THE VALIDATION LOGIC. MAYBE A TYPE OF ORDER VARIABLE SHOUD BE PASSED, SO THERE IS A DIFFERENCE BETWEEN THE TWO WAYS OF FILLING UP CONTACT INFO
export default function PageLeftSideKC() {
  const {
    contactInfoState,
    getContactInfoFuncs: {
      handleNameChange,
